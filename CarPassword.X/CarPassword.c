 ...
 *
 * The main file containig the basic algorithm. Displays prompts to the user to
 * enter the password, check it, and turn on/off the car and security warnings. In addition to
 *an option of changing the password.
 */
...
#pragma config LVP=OFF,BOREN=OFF,WDTE=OFF,FOSC=HS     //device configurations
//high speed osc., no low voltage programming, no watchdog timer, power-up timer and brown-out reset
