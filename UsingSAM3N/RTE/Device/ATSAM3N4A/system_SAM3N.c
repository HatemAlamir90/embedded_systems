...
#define PMC_PCER_Val    0x80000C00      // WO register (0x00000000)
#define CKGR_MOR_Val    0x00370108      // 0x00000001
#define CKGR_PLLR_Val   0x200F8600      // 0x00003F00
#define PMC_MCKR_Val    0x00000001      // 0x00000001
